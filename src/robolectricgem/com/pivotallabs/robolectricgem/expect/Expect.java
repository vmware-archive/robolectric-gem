...
public class Expect {
    ...
    public static <T extends Class, M extends com.pivotallabs.robolectricgem.matchers.ClassMatcher<T, M>> com.pivotallabs.robolectricgem.matchers.ClassMatcher<T, ?> expect(T actual) {
        return wrapped(com.pivotallabs.robolectricgem.matchers.ClassMatcher.class, actual);
    }
